...
public class UtilityFunctions {
	...
	public void SelectDropDownVisibleText(String sObject, String sIdentifier, String sText)
	{
		...
		case "CLASS":
			...
			break;
		case "CSSSELECTOR":
			Select drp7 = new Select (driver.findElement(By.cssSelector(sIdentifier)));
			drp7.selectByVisibleText(sText);
			break;
	...
	{
		//Scroll using Page Down
		driver.findElement(By.cssSelector("body")).sendKeys(Keys.SUBTRACT);
	}
