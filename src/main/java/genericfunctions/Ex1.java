...
public class Ex1 {
	...
	public void Test_5() throws Exception
	{
		...
		//Enter First Name
		utils.EnterText("xpath", "//*[contains(text(),'Name')]/following::input[1]", "Tatum");
		
		//Enter Last Name
		utils.EnterText("xpath", "//*[contains(text(),'Name')]/following::input[2]", "Hill");
		...
		//Enter Mobile
		utils.EnterText("xpath", "//*[contains(text(),'Mobile')]/following::input[1]", "123456789");
		
		
		
		
		//Enter Date of Birth
		utils.EnterText("xpath", "//*[contains(text(),'Date of Birth')]/following::input[1]", "14 May 2021");
		
		utils.ClickObject("ID", "dateOfBirth");
		
		
		//Enter Subjects
		//utils.EnterText("xpath", "//*[contains(text(),'Subjects')]/following::input[1]", "Maths");
		utils.EnterText("xpath", "//*[contains(text(),'Subjects')]/following::input[1]", "Maths");
		utils.getWebdriver().findElement(By.xpath("//*[contains(text(),'Subjects')]/following::input[1]")).sendKeys(Keys.ENTER);
		...
		//Upload Document - *Not required Bonus*
		//utils.FileUpload("‪‪C:\\ExtentLogFail20210311_152925.png");
